...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    @Query(value = "SELECT b.board_id AS boardId, b.title, b.content, b.content_html AS contentHtml, b.emotion, b.created_at AS createdAt, b.modified_at AS modifiedAt, b.user_id AS userId, u.nickname " +
    ...
    @Query(value = "SELECT b.board_id AS boardId, b.title, b.content, b.content_html AS contentHtml, b.emotion, b.created_at AS createdAt, b.modified_at AS modifiedAt, b.user_id AS userId, u.nickname, u.username " +
